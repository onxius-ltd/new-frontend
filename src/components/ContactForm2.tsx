...
const ContactForm2: React.FC = () => {
      ...
      // ── Call schedule onChange ────────────────────────────────────────────────
      // Only clear an error when its OWN field gets a non-empty value.
      // Never pre-emptively clear the other half — let validate() control that.
      ...
      const validate = (): boolean => {
            ...
            // ── Required plain text / select / radio fields ───────────────────
            ...
            // ── Call schedule — BOTH date and time are now required ───────────
      ...
      return (
            <div className="min-h-screen">
                  ...
                  <div className="fixed inset-0 pointer-events-none overflow-hidden">
                        <div className="absolute -top-60 -left-40 w-[700px] h-[700px] rounded-full blur-[140px]" style={{ background: "rgba(241,128,39,0.06)" }} />
                        <div className="absolute -bottom-40 -right-20 w-[500px] h-[500px] rounded-full blur-[120px]" style={{ background: "rgba(238,95,17,0.04)" }} />
                  </div>
                        ...
                        <AnimatePresence mode="wait">
                              {submitted ? (
                                    ...
                                    >
                                          ...
                                          {/* ── Main card ── */}
                                          <div className="rounded-lg p-5 bg-white shadow-sm mb-1">
                                                <form onSubmit={handleSubmit} noValidate>
                                                      <div className="grid grid-cols-2 gap-x-4 gap-y-5">
                                                            ...
                                                            <div className="flex flex-col" data-error={!!errors.name}>
                                                                  <FloatingInput name="name" label="Your Name" value={get("name")} onChange={handleChange} required index={idx()} />
                                                                  <FieldError msg={errors.name} />
                                                            </div>
                                                            <div className="flex flex-col" data-error={!!errors.email}>
                                                                  <FloatingInput name="email" label="Your Email" type="email" value={get("email")} onChange={handleChange} required index={idx()} />
                                                            ...
                                                            <div className="flex flex-col" data-error={!!errors["business-name"]}>
                                                                  <FloatingInput name="business-name" label="Business Name" value={get("business-name")} onChange={handleChange} required index={idx()} />
                                                            ...
                                                            <div className="col-span-2 flex flex-col" data-error={!!errors.project}>
                                                                  <FloatingSelect name="project" label="What do you need from Onxius?" options={ProjectType} value={get("project")} onChange={handleChange} required index={idx()} fullWidth />
                                                            ...
                                                            <div className="col-span-2 flex flex-col" data-error={!!errors["service-type"]}>
                                                                  <RadioGroup
                                                                        name="service-type"
                                                            ...
                                                            <AnimatePresence>
                                                                  {isUpdating && (
                                                                        ...
                                                                        >
                                                                              <div className="flex flex-col" data-error={!!errors["existing-app-web-link-update"]}>
                                                                                    <FloatingInput
                                                            ...
                                                            <div className="flex flex-col" data-error={!!errors["business-location"]}>
                                                                  <FloatingInput name="business-location" label="Business Location (City, Country)" value={get("business-location")} onChange={handleChange} required index={idx()} />
                                                                  <FieldError msg={errors["business-location"]} />
                                                            </div>
                                                            <div className="flex flex-col" data-error={!!errors["business-scope"]}>
                                                                  <FloatingSelect name="business-scope" label="Business Scope" options={BusinessScope} value={get("business-scope")} onChange={handleChange} required index={idx()} tooltip="Which audience are you targeting? Local, nationwide, or international?" />
                                                            ...
                                                            <AnimatePresence>
                                                                  {hasOwnDomain && (
                                                                        <motion.div
                                                                              ...
                                                                              className="col-span-2 overflow-hidden"
                                                                        >
                                                                              <div className="flex flex-col" data-error={!!errors["existing-domain-link"]}>
                                                                                    <FloatingInput
                                                            ...
                                                            <AnimatePresence>
                                                                  {isOtherApp && (
                                                                        <motion.div
                                                                              ...
                                                                              className="col-span-2 overflow-hidden"
                                                                        >
                                                                              <div className="flex flex-col" data-error={!!errors["other-application-type"]}>
                                                                                    <FloatingInput
                                                            ...
                                                            <div className="col-span-2 flex flex-col" data-error={!!errors["website-features"]}>
                                                                  <FeaturesSelector value={getArr("website-features")} onChange={(v) => set("website-features", v)} index={idx()} />
                                                                  <FieldError msg={errors["website-features"]} />
                                                            </div>
                                                            <div className="col-span-2 flex flex-col" data-error={!!errors["language-options"]}>
                                                                  <MultiSelect name="language-options" label="Language Options" options={LanguageOptions} value={getArr("language-options")} onChange={(n, v) => set(n, v)} index={idx()} tooltip="Select all languages your website should support." />
                                                                  <FieldError msg={errors["language-options"]} />
                                                            </div>

                                                            {/* Design Inspiration */}
                                                            <SectionHeading label="Design Inspiration" index={idx()} />
                                                            <SampleSitesInput value={getArr("sample-sites")} onChange={(v) => set("sample-sites", v)} index={idx()} />

                                                            {/* Content & Media */}
                                                            <SectionHeading label="Content & Media" index={idx()} />

                                                            <div className="flex flex-col" data-error={!!errors["website-content"]}>
                                                                  <RadioGroup name="website-content" label="Do you need us to write the website content?" options={BooleanOptions} value={get("website-content")} onChange={set} index={idx()} tooltip="Our professional writers craft compelling, SEO-friendly copy tailored to your audience." />
                                                                  <FieldError msg={errors["website-content"]} />
                                                            </div>
                                                            <div className="flex flex-col" data-error={!!errors["media-content"]}>
                                                                  <RadioGroup name="media-content" label="Do you need professional photos / graphics?" options={BooleanOptions} value={get("media-content")} onChange={set} index={idx()} tooltip="Our design team produces custom imagery and branding assets." />
                                                            ...
                                                            <div className="col-span-2 flex flex-col" data-error={!!errors["on-going-maintenance"]}>
                                                                  <RadioGroup name="on-going-maintenance" label="Do you need ongoing maintenance & support?" options={MaintenanceSupportOptions} value={get("on-going-maintenance")} onChange={set} index={idx()} fullWidth tooltip="Monthly maintenance keeps your site secure, updated and running smoothly." />
                                                            ...
                                                            <div className="col-span-2 flex flex-col" data-error={!!errors.budget}>
                                                                  <FloatingSelect name="budget" label="Budget Range" options={BudgetOptions} value={get("budget")} onChange={handleChange} required index={idx()} fullWidth />
                                                                  <FieldError msg={errors.budget} />
                                                            </div>
                                                            <FloatingTextarea name="message" label="Anything else you'd like us to know?" value={get("message")} onChange={handleChange} index={idx()} />

                                                            {/* ReCAPTCHA */}
                                                            <div className="col-span-2 flex flex-col gap-1" data-error={!!errors.captcha}>
                                                                  <ReCAPTCHA
                                                                        ref={recaptchaRef}
                                                            ...
                                                            {/* Submit */}
                                                            <motion.div variants={fadeUp} custom={idx()} initial="hidden" animate="visible" className="col-span-2 mt-4">
                                                                  <button
                                                                        type="submit"
                                                                        disabled={loading}
                                                                        ...
                                                                        onMouseEnter={(e) => { if (!loading) (e.currentTarget as HTMLButtonElement).style.background = "var(--dark-blue-clr)"; }}
                                                                        onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "var(--sky-clr)"; }}
                                                                  >
                                                                        <AnimatePresence mode="wait">
                                                                              {loading ? (
